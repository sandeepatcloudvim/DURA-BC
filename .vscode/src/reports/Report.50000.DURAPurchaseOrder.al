report 50000 "Dura Purchase Order"
{
    RDLCLayout = './DuraPurchaseOrder.rdlc';
    WordLayout = './DuraPurchaseOrder.docx';
    Caption = 'Purchase Order Dura';
    DefaultLayout = Word;
    ...
    dataset
    {
        dataitem("Purchase Header"; "Purchase Header")
        {
            ...
            dataitem("Purchase Line"; "Purchase Line")
            {
                ...
                column(Bag_Style; recItem."Bag Style")
                {

                }
                column(Film_Structure; recItem."Film Structure")
                {

                }
                column(color; recItem.Color)
                {

                }
                column(Gusset_Style; recItem."Gusset Style")
                {
                }
                column(Barrier_Level; recItem."Barrier Level")
                {
                }
                column(Zipper; recItem.Zipper)
                {

                }
                column(Hang_Hole; recItem."Hang Hole")
                {

                }
                column(Window; recItem.Window)
                {
                }
                column(Fill_Style; recItem."Fill Style")
                {

                }
                column(Bag_Length; recItem."Bag Length")
                {
                }
                column(Bag_Width; recItem."Bag Width")
                {

                }
                column(Bag_Gusset; recItem."Bag Gusset")
                {
                }
                column(Bag_Tear_Notch; recItem."Bag Tear Notch")
                {

                }
                column(Bag_Volume; recItem."Bag Volume")
                {
                }
                column(Bag_Thickness; recItem."Bag Thickness")
                {

                }
                column(Bag_Weight; recItem."Bag Weight")
                {
